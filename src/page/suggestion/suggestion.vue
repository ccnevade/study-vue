...
<div class="has_content_top_fixed no_content_footer">
    ...
    <div class="content_body">
        <el-table :data="suggestionList" stripe style="width: 100%">
            <el-table-column prop="title" label="标题"></el-table-column>
            <el-table-column prop="content" label="内容"></el-table-column>
            <el-table-column prop="author" label="建议者"></el-table-column>
...
export default {
    ...
    methods: {
        initData() {
            ...
            this.$http.post(self.globalUrl.suggestion.suggestionPage, JSON.stringify(postData)).then(function(res) {
                if (res.data.code == 200000) {
                    self.suggestionList = res.data.data.content;
        ...
        editSubmit() {
            ...
            var postUrl = self.globalUrl.suggestion.suggestionEdit;
            if (this.editType == -1) {
                postUrl = self.globalUrl.suggestion.suggestionAdd;
            }
        ...
        del(index, data) {
            var self = this;
            this.$confirm('此操作将永久删除该意见建议, 是否继续?', '提示', {
                confirmButtonText: '确定',
                cancelButtonText: '取消',
                type: 'warning'
            }).then(() => {
                this.$http.get(self.globalUrl.suggestion.suggestionDel + data.id).then(function(res) {
                    if (res.data.code == 200000) {
                        self.initData();
